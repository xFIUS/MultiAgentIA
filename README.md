SStatus: Archive (code is provided as-is, no updates eexpected)
...
observation(): defines the observation space of a given agent
(optional) benchmark_data(): provides diagnostic data for policies trained on the environment (e.g. evaluation metrics)
