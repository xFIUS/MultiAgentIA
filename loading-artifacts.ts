---
/**
 * PageSidebar override - adds CopyPageButton above the Table of Contents
 * Preserves Starlight's default structure and responsive behavior
 */
...

{
  Astro.locals.starlightRoute.toc && (
    <>
      <div class="lg:sl-hidden mx-auto ml-4">
        <CopyPageButton />
      </div>
...
<style>
  @layer starlight.core {
    ...
    .mobile-copy-wrapper :global(.copy-page-wrapper) {
      margin-bottom: 0;
    }
  }
</style>
